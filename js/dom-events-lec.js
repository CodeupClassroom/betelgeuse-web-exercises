...
(function(){
    ...
    /**
     * Audience: "David, it sure seems like I can do a lot with JavaScript to my web pages, but how can I make it so my
     * user can activate the changes instead of them happening on page load?"
     */
    ...
    /**
     * Audience: "But David, as we've seen before, if we can create, can we not also destroy? How could I remove an event listener?"
     */
